(() => {
  ...
  const CHARACTERS = [
    ...
    c("valkorin", "Valkorin Dusk", "SSR+", "Twilight Sovereign", "Senja", "#c96fd6", "☾", "Twilight Decree", "Membalik urutan giliran satu putaran, memberimu giliran ekstra langsung setelah lawan.", "Dusk Authority", "Semua kota yang kamu miliki memberi kontrol tambahan 8% saat matahari terbenam (giliran genap).", 93, 91, 89, 90, 22),
    c("pyrhessa", "Pyrhessa Core", "SSR+", "Magma Regent", "Magma", "#ff7a3d", "♨", "Magma Surge", "Melelehkan satu penghalang atau segel yang menargetkanmu, lalu memberi 15% koin bonus.", "Living Furnace", "Pertahanan meningkat 12% saat berada di kota vulkanik atau industri.", 91, 87, 96, 85, 22),
    c("celestine", "Celestine Astra", "SSR+", "Starbound Empress", "Bintang", "#7ec8ff", "✦", "Astral Convergence", "Menarik satu kartu kesempatan langka tambahan dan memilih efek terbaik dari dua opsi.", "Constellation", "Peluang dadu kembar meningkat 10%, bertambah 2% tiap SSR+ lain yang kamu miliki.", 95, 90, 88, 86, 24),
    c("morwenna", "Morwenna Tide", "SSR+", "Abyssal Matriarch", "Air Dalam", "#3d7fae", "≈", "Tidal Reckoning", "Membanjiri satu kota lawan, menghentikan pendapatannya selama dua giliran penuh.", "Endless Depth", "Kebal terhadap seluruh efek berbasis air; pendapatan kota biru meningkat 15%.", 90, 92, 91, 93, 22),

    c("garreth", "Garreth Hollow", "SSR", "Cave Overseer", "Gua", "#7d7361", "⛰", "Hollow Watch", "20% peluang mengetahui isi kartu kesempatan lawan sebelum mereka membukanya.", "Stone Sense", "Bonus pendapatan meningkat 8% di kota pegunungan.", 84, 82, 85, 83, 12),
    c("nissa", "Nissa Verdant", "SSR", "Grove Warden", "Hutan Purba", "#6fae5a", "❀", "Grove Blessing", "Memulihkan satu kota yang disegel atau dibekukan menjadi normal kembali.", "Ancient Roots", "Biaya upgrade kota hijau berkurang 12%.", 86, 80, 76, 85, 12),
    c("kestrel", "Kestrel Vane", "SSR", "Wind Rider", "Baling-baling", "#7fc9d6", "➤", "Vane Rush", "24% peluang mendapat giliran tambahan langsung setelah dadu ganjil.", "Aerial Grace", "Kecepatan gerak meningkat 6% di seluruh papan.", 88, 89, 79, 74, 12),
    c("oriana", "Oriana Vex", "SSR", "Curse Broker", "Kutukan", "#9a5cc9", "☠", "Vex Trade", "Menjual satu efek negatif milikmu kepada lawan dengan imbalan 20% koin.", "Bitter Pact", "Efek negatif terhadapmu berkurang 12%.", 85, 83, 78, 80, 12),
    c("baldric", "Baldric Stone", "SSR", "Wall Breaker", "Palu Batu", "#a89070", "⚒", "Wall Breaker", "22% peluang mengambil alih kota berpenjaga tanpa membayar penalti penuh.", "Heavy Hand", "Power meningkat 6% saat menyerang kota bertahan.", 82, 79, 90, 81, 12),
    c("selwyn", "Selwyn Marrow", "SSR", "Grave Diplomat", "Kapur", "#b0a89c", "✎", "Grave Accord", "Menghidupkan kembali satu kartu kesempatan yang sudah terpakai untuk dipakai ulang.", "Solemn Vow", "Bonus riwayat kartu kesempatan meningkat 8%.", 83, 86, 77, 79, 12),
    c("tamriel", "Tamriel Dawn", "SSR", "Border Sentinel", "Perbatasan", "#e0b380", "⚑", "Border Watch", "Mencegah satu lawan melewati kotamu tanpa membayar tol, peluang 30%.", "Vigilant Line", "Pendapatan tol meningkat 10%.", 84, 81, 84, 87, 12),
    c("issolde", "Issolde Wren", "SSR", "Featherlight Scout", "Bulu", "#f0c9e0", "❁", "Featherlight", "20% peluang menghindari seluruh biaya perjalanan dalam satu giliran.", "Downy Step", "Kontrol dadu meningkat 6% saat koin di bawah 30%.", 87, 88, 75, 77, 12),

    c("bevin", "Bevin Ashwood", "SR", "Timber Broker", "Kayu Bakar", "#b08a5c", "⚒", "Timber Deal", "16% peluang mendapat diskon tambahan saat membangun kota kayu.", "Seasoned Wood", "Ketahanan kota meningkat 5% terhadap efek api.", 75, 73, 78, 76, 5),
    c("prisca", "Prisca Loom", "SR", "Weaver Apprentice", "Tenun", "#e0a8c9", "❦", "Loom Weave", "18% peluang menggabungkan dua efek kartu kesempatan ringan menjadi satu.", "Steady Thread", "Bonus kesempatan positif meningkat 5%.", 77, 74, 69, 73),
    c("dunmore", "Dunmore Hale", "SR", "Guard Recruit", "Perisai Muda", "#9aa8b8", "⛊", "Recruit Guard", "15% peluang menahan satu upaya pengambilalihan kota.", "Steady Stance", "Pertahanan meningkat 6%.", 73, 72, 81, 79, 5),
    c("ferra", "Ferra Combs", "SR", "Market Crier", "Lonceng Pasar", "#f0d08a", "♪", "Market Call", "18% peluang menaikkan harga jual asetmu sebesar 12% untuk satu transaksi.", "Loud Voice", "Bonus perhatian pasar meningkat 5%.", 76, 71, 68, 72),
    c("gideon", "Gideon Marsh", "SR", "Toll Collector", "Portal Tol", "#8ea0c9", "⚑", "Toll Grip", "20% peluang menggandakan pendapatan tol dari satu kota selama satu giliran.", "Firm Hand", "Kehilangan tol berkurang 8%.", 78, 75, 74, 77, 5),
    c("wrenna", "Wrenna Sol", "SR", "Sunlit Scout", "Cahaya Pagi", "#ffe0a0", "☼", "Sunlit Path", "16% peluang melihat efek dua petak ke depan sekaligus.", "Morning Glow", "Bonus START meningkat 4%.", 79, 76, 67, 71),
    c("castor", "Castor Bane", "SR", "Rival Hunter", "Perburuan", "#c98a8a", "⚔", "Rival Mark", "18% peluang mengurangi power lawan terkuat sebesar 8% selama satu giliran.", "Grudge Focus", "Power meningkat 5% saat melawan pemimpin klasemen.", 80, 78, 82, 74, 5),
    c("liora", "Liora Vane", "SR", "Cloudweaver", "Awan Tipis", "#a8d6f0", "☁", "Cloudweave", "16% peluang membuat satu petak berbahaya menjadi netral selama satu giliran.", "Soft Veil", "Efek buruk ringan berkurang 6%.", 78, 77, 66, 73),
    c("harwin", "Harwin Cole", "SR", "Ledger Auditor", "Buku Neraca", "#9ec9b0", "✎", "Ledger Audit", "18% peluang mengungkap seluruh biaya tersembunyi lawan dalam satu giliran.", "Precise Count", "Kesalahan hitung sewa menguntungkanmu 5%.", 77, 79, 71, 74, 5),
    c("selby", "Selby Thorne", "SR", "Bramble Runner", "Semak Duri", "#a3c470", "✤", "Bramble Dash", "16% peluang melewati petak duri tanpa penalti dan mendapat gerak tambahan.", "Thorned Path", "Musuh yang mengejarmu kehilangan 4% kecepatan.", 76, 80, 70, 72),

    c("pippa", "Pippa Wick", "R", "Candle Sprout", "Sumbu Lilin", "#ffdca8", "✧", "Small Flame", "7% peluang menerangi petak gelap terdekat.", "Warm Glow", "Bonus kartu kesempatan ringan meningkat 2%.", 55, 53, 52, 56),
    c("dorric", "Dorric Vane", "R", "Weather Novice", "Cuaca", "#a8c9e0", "☁", "Mild Breeze", "8% peluang mengurangi efek cuaca buruk sedikit.", "Fair Skies", "Kontrol dadu meningkat 2% saat cuaca cerah.", 57, 58, 53, 55),
    c("nettie", "Nettie Furrow", "R", "Sprout Farmer", "Bibit", "#a8c98a", "⚘", "Small Harvest", "7% peluang panen kecil di kota hijau.", "Green Thumb", "Bonus panen meningkat 2%.", 56, 54, 55, 58),
    c("colm", "Colm Ferry", "R", "Ferry Hand", "Perahu", "#8ac9c2", "≋", "Ferry Assist", "8% peluang menyeberang tanpa biaya tambahan.", "Steady Oar", "Biaya penyeberangan berkurang 2%.", 58, 57, 51, 54),
    c("bettina", "Bettina Crisp", "R", "Bakery Runner", "Roti", "#f0d0a0", "✤", "Fresh Batch", "7% peluang mendapat bonus koin kecil dari penjualan kecil.", "Warm Bread", "Modal awal meningkat 2%.", 54, 55, 56, 57),
    c("aldric", "Aldric Fenn", "R", "Fen Wanderer", "Rawa Kecil", "#8a9a70", "☘", "Fen Step", "8% peluang menghindari lumpur ringan.", "Muddy Boots", "Efek terjebak berkurang 2%.", 57, 56, 54, 58),
    c("linden", "Linden Cross", "R", "Crossroad Kid", "Persimpangan", "#c9b88a", "▰", "Path Choice", "7% peluang memilih arah alternatif saat persimpangan.", "Curious Mind", "Bonus eksplorasi meningkat 2%.", 59, 58, 50, 53),
    c("marisol", "Marisol Reed", "R", "Reed Weaver", "Anyaman", "#a0d6c0", "✤", "Reed Weave", "8% peluang memperbaiki kerusakan ringan pada asetmu.", "Nimble Fingers", "Biaya perbaikan berkurang 2%.", 55, 56, 57, 59),
    c("rufus", "Rufus Dell", "R", "Hound Keeper", "Anjing", "#c9a070", "⚑", "Loyal Bark", "7% peluang memperingatkanmu dari efek negatif mendatang.", "Faithful Guard", "Peluang terkejut berkurang 2%.", 58, 55, 56, 57),
    c("reedling", "Reedling Vale", "R", "Marsh Sprout", "Rawa Muda", "#8ac2a0", "☘", "Marsh Step", "7% peluang melewati rawa tanpa efek.", "Small Roots", "Bonus kota rawa meningkat 2%.", 56, 57, 55, 58)
  ];
